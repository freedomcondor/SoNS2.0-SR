...
run () {
	...
	#python3 ~/code/SoNS2.0-SR/build/experiments/exp_2_simu_scalability_analyze/run.py -r $i -v false >> output
	lua ~/code/SoNS2.0-SR/build/experiments/exp_2_simu_scalability_analyze/scripts/evaluator.lua $i >> evaluate_output
}
