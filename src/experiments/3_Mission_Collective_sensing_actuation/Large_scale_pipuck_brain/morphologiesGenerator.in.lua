...
function create_3pipuck_9drone_children_chain(n, droneDis, pipuckDis, height, position, orientationQ, left_or_right)
	if n == 0 then return nil end
	if n == 1 then 
		return create_1pipuck_3drone_children_node(droneDis, pipuckDis, height, position, orientationQ)
	end
	--local node = create_3drone_12pipuck_children_node(droneDis, pipuckDis, height, position, orientationQ)
	local node = create_3pipuck_9drone_children_node(droneDis, pipuckDis, height, position, orientationQ, left_or_right)
	table.insert(node.children,
		create_3pipuck_9drone_children_chain(n-1, droneDis, pipuckDis, height, 
...
{	robotTypeS = "pipuck",
	...
	create_3pipuck_9drone_children_chain(scale, droneDis, pipuckDis, height, 
...
function create_back_line_morphology(scale, droneDis, pipuckDis, height)
	local node = create_3pipuck_9drone_children_node(droneDis, pipuckDis, height, vector3(), quaternion())
...
-- structure 3 -----------------------------------------------------
local function create_3pipuck_9drone_children_back_line_node(droneDis, pipuckDis, height, position, orientationQ)
	local node = create_1pipuck_3drone_children_node(droneDis, pipuckDis, height, position, orientationQ)
	local second_node = 
		create_1pipuck_3drone_children_node(droneDis, pipuckDis, height, 
			vector3(-droneDis, 0, 0),
...
function create_3pipuck_9drone_children_back_line_chain(n, droneDis, pipuckDis, height, position, orientationQ)
	if n == 0 then return nil end
	local node = create_3pipuck_9drone_children_back_line_node(droneDis, pipuckDis, height, position, orientationQ)
	table.insert(node.children,
		create_3pipuck_9drone_children_back_line_chain(n-1, droneDis, pipuckDis, height, 
...
function create_left_right_back_line_morphology(scale, droneDis, pipuckDis, height)
	...
	local node = create_1pipuck_3drone_children_node(droneDis, pipuckDis, height, vector3(), quaternion())
	table.insert(node.children,
		create_3pipuck_9drone_children_back_line_chain(scale, droneDis, pipuckDis, height, 
			vector3(x, -y, 0),
