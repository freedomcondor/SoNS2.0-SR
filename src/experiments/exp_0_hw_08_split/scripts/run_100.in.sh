...
DATADIR=@CMAKE_MNS_DATA_PATH@/src/experiments/exp_0_hw_08_split/data_hw/data
#DATADIR=@CMAKE_MNS_DATA_PATH@/src/experiments/exp_0_hw_08_split/data_simu/data
TMPDIR=threads
