...
dataFolder = "@CMAKE_SoNS_DATA_PATH@/src/experiments/exp_0_hw_03_obstacle_avoidance_large/data_simu/data"
savePDFNameBase = "mission2_large_obstacles_exp0_03_simu_"
sampleList = [
	"run3",
	"run9",
	"run29",
