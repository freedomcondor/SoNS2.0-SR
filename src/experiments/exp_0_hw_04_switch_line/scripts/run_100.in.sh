...
#DATADIR=@CMAKE_SoNS_DATA_PATH@/src/experiments/exp_0_hw_04_switch_line/data_hw/data
DATADIR=@CMAKE_SoNS_DATA_PATH@/src/experiments/exp_0_hw_04_switch_line/data_simu/data
TMPDIR=threads
