...
raw_exps_dir="/media/harry/Expansion/Storage/SoNS2.0-data/src/experiments"
...
# copy README
cp /home/harry/code-mns2.0/SoNS2.0-SR/src/scripts/public_data_readmes/Root_readme.txt $public_dir/README
for i in ${!data_set_lists[@]}; do
	read -a exp_tuple <<< ${data_set_lists[$i]}
	cp /home/harry/code-mns2.0/SoNS2.0-SR/src/scripts/public_data_readmes/Data_set_readme.txt $public_dir/${exp_tuple[1]}/README
done

for i in ${!special_readme_list[@]}; do
	cp /home/harry/code-mns2.0/SoNS2.0-SR/src/scripts/public_data_readmes/Data_set_readme.txt $public_dir/${special_readme_list[$i]}/README
done
