...
--]]
package.path = package.path .. ";/home/harry/code-mns2.0/SoNS2.0-SR/build/experiments/5_Mission_Splitting_merging/Variant1_Search_and_rescue_in_passage/Large_scale_simulation_experiments/?.lua"
if robot.params.hardware ~= "true" then
	package.path = package.path .. ";/home/harry/code-mns2.0/SoNS2.0-SR/build/experiments/5_Mission_Splitting_merging/Variant1_Search_and_rescue_in_passage/Large_scale_simulation_experiments/simu/?.lua"
end
