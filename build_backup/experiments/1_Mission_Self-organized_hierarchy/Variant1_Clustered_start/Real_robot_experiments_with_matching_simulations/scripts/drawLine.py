...
dataFolder = "/home/harry/code-mns2.0/SoNS2.0-SR/src/../../SoNS2.0-data/src/experiments/exp_0_hw_10_formation_1_2d_6p_group_start/data_hw/data"


'''
#-------------------------------------------------------------------------
# draw data plain
for subfolder in getSubfolders("/home/harry/code-mns2.0/SoNS2.0-SR/src/experiments/1_Mission_Self-organized_hierarchy/Variant1_Clustered_start/Real_robot_experiments_with_matching_simulations/scripts/../data") :
