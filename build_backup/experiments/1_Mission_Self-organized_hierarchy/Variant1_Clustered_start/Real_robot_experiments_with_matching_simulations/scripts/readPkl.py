parseJournalFileName = "/home/harry/code-mns2.0/SoNS2.0-SR/src/scripts/pklReader/parse_journal.py"
exec(compile(open(parseJournalFileName, "rb").read(), parseJournalFileName, 'exec'))

logGeneratorFileName = "/home/harry/code-mns2.0/SoNS2.0-SR/src/scripts/pklReader/logGenerator.py"
