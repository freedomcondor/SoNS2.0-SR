...
package.path = package.path .. ";/home/harry/code-mns2.0/SoNS2.0-SR/build/experiments/2_Mission_Global_local_goals/Variant2_Larger_less_dense_obstacles/Real_robot_experiments_with_matching_simulations/?.lua"
--]]
if robot.params.hardware ~= "true" then
	package.path = package.path .. ";/home/harry/code-mns2.0/SoNS2.0-SR/build/experiments/2_Mission_Global_local_goals/Variant2_Larger_less_dense_obstacles/Real_robot_experiments_with_matching_simulations/simu/?.lua"
end
...
function reset()
	...
	{ type = "sequence", children = {
		...
		sons.Driver.create_driver_node(sons, {waiting = waiting_flag}),
	}}
end
...
return function()
	...
	if sons.api.stepCount < 200 then 
