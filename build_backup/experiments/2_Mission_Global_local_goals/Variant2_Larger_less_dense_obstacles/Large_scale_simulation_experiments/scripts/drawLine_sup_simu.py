...
dataFolder = "/media/harry/Expansion/Storage/SoNS2.0-data/src/experiments/exp_1_simu_03_obstacle_avoidance_large_10d/data_simu/data"

savePDFNameBase = "mission2_large_obstacle_10drone_exp1_02_simu_"
sampleList = [
	"run1",
	"run40",
	"run45",
