...
option = {
	'dataFolder' : "/media/harry/Expansion/Storage/SoNS2.0-data/src/experiments/exp_1_simu_02_obstacle_avoidance_small_10d/data_simu/data",
	'sample_run'             : "run1",
	...
	'double_right'           : True,
	'double_right_dataFolder': "/media/harry/Expansion/Storage/SoNS2.0-data/src/experiments/exp_1_simu_03_obstacle_avoidance_large_10d/data_simu/data",

#------------------------------------------------
	'brain_marker'      :    '/home/harry/code-mns2.0/SoNS2.0-SR/src/scripts/brain-icon-small.svg',
	'key_frame' :  [0, 800] ,
	'overwrite_trackFig_log_foler' : 
		"/media/harry/Expansion/Storage/SoNS2.0-data/src/experiments/exp_1_simu_02_obstacle_avoidance_small_10d/data_simu/track_fig_logs"
	,
