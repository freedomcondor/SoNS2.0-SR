...
--package.path = package.path .. ";/home/harry/code-mns2.0/SoNS2.0-SR/build/experiments/7_Fault_tolerance/Real_robot_experiments_with_matching_simulations/scripts/../simu/?.lua"
package.path = package.path .. ";/media/harry/Expansion/Storage/SoNS2.0-data/src/experiments/exp_0_hw_07_fault_tolerance/data_hw/data/test_20220712_6_success_5/hw/?.lua"
