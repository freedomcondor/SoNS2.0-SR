...
dataFolder = "/media/harry/Expansion/Storage/SoNS2.0-data/src/experiments/exp_3_simu_04_fault_tolerance_visual/data_simu_0.5s/data"
sample_run = "run26"
...
# -------- loss 1s ---------------------
track_option = track_option_base.copy()
dataFolder = "/media/harry/Expansion/Storage/SoNS2.0-data/src/experiments/exp_3_simu_04_fault_tolerance_visual/data_simu_1s/data"
sample_run = "run43"
