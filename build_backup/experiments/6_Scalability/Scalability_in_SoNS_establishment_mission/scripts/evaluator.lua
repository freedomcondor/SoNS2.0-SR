...
package.path = package.path .. ";/home/harry/code-mns2.0/SoNS2.0-SR/build/experiments/6_Scalability/Scalability_in_SoNS_establishment_mission/scripts/../simu/?.lua"
