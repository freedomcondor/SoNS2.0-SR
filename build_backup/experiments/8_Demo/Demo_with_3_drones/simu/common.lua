...
package.path = package.path .. ";/home/harry/code-mns2.0/SoNS2.0-SR/build/experiments/8_Demo/Demo_with_3_drones/?.lua"
--]]
if robot.params.hardware ~= "true" then
	package.path = package.path .. ";/home/harry/code-mns2.0/SoNS2.0-SR/build/experiments/8_Demo/Demo_with_3_drones/simu/?.lua"
end
...
-- SoNS.Allocator.calcBaseValue = function() return 0 end-- default is oval
...
function reset()
	...
	{ type = "sequence", children = {
		...
		sons.create_sons_core_node(sons, {drone_pipuck_avoidance = false}),
